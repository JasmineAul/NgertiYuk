  ...
  <div class="content">
    ...
    <div class="materi-grid">
      <div class="materi-card">
        <div class="icon">📄</div>
        <button onclick="location.href='klasifikasi_pdf_pgn.php'">PDF</button>
      </div>
      <div class="materi-card">
        <div class="icon">🎥<br></div>
        <button onclick="location.href='klasifikasi_mp4_pgn.php'">Video</button>
      </div>
      <div class="materi-card">
        <div class="icon">📽️</div>
        <button onclick="location.href='klasifikasi_pptx_pgn.php'">PPT</button>
      </div>
      <div class="materi-card">
        <div class="icon">🎵<br></div>
        <button onclick="location.href='klasifikasi_mp3_pgn.php'">MP3</button>
      </div>
    </div>
  </div>
</body>
