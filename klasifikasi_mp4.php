...
$sql = "SELECT * FROM materi WHERE kategori = 'mp4' ORDER BY created_at DESC";
...
<body>
    <div class="navbar">
        ...
        <?php while ($row = $result->fetch_assoc()): ?>
            <div class="card">
                <div class="action-icons">
                    <a href="edit_materi.php?id=<?php echo $row['id']; ?>" title="Edit">✏️</a>
                    <a href="hapus_materi.php?id=<?php echo $row['id']; ?>" title="Hapus" onclick="return confirm('Yakin ingin menghapus materi ini?');">🗑️</a>
                </div>
        ...
        <!-- Card Tambah Materi -->
        <div class="card">
            <a href="form_tambah_materi.php" style="text-decoration: none; color: inherit;">
                <div class="card-icon" style="font-size: 50px; color: white;">➕</div>
                <button style="margin-top: 10px;">Tambah Materi</button>
            </a>
        </div>
    </div>
    <a class="back" href="kategori_materi_operator.php">← Kembali</a>
</body>
</html>